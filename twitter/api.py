...
class TwitterCall(object):
    ...
    def _handle_response(self, req, uri, arg_data, _timeout=None):
		...
		print("Error 429: Too Many Requests. Wait 15 minutes and try again. Current time: " + str(datetime.strptime(datetime.now().strftime("%Y %m %d %H:%M:%S"), "%Y %m %d %H:%M:%S")) + " UTC")
		raise SystemExit
	    elif (e.code == 404):
		print("Error 404: Not Found. The account was not found.")
            else:
