...
from s14_twitter_email_creds import *	#Gmail credentials
from twitter import *
...
try:
	...
	raise SystemExit
try:
	keyword_search = [line.strip() for line in open('keywords')]		#text file containing keywords to scan accounts for
except:
